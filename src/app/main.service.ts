...
export class MainService {
  ...
  public GetProducts(index: number, count: number, orderby: string, desc: boolean) {
    ...
    return this.http.get<Product[]>(this.root + 'Product',  { headers: this.auth.getAuthorizationHeaders(), params : params });
  }
